(function(){
    ...
    mainAngularModule.directive('dhxGantt', function() {
        return {
            restrict: 'A',
            scope: false,
            transclude: true,
    ...
    mainAngularModule.directive('ganttTemplate', ['$interpolate', function($interpolate){
        return {
            restrict: 'AE',
            terminal:true,
    ...
    mainAngularModule.directive('ganttColumn', ['$interpolate', function($interpolate){
        return {
            restrict: 'AE',
            terminal:true,
    ...
    mainAngularModule.directive('ganttColumnAdd', [function(){
        return {
            restrict: 'AE',
            terminal:true,
            link:function(){
